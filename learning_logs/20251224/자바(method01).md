...
// method 정의 영역
    ...
    /*
        ...
        특정 메서드의 결과값(return)이 다른 메서드와 argument로 사용될 수도 있습니다.

        함수형 프로그래밍 (functioal programming) :
     ...
     */
        ...
        call2(feeling);
        call3();
        System.out.println(call3());    // return이라는 것은 콘솔에 출력하라는 의미가 절대아니고
                                        // 특정 데이터가 뽑혀져 나온다는 겁니다.
                                        // 그것을 변수에 저장한 다음 개발자들은 개발자 입맛대로
                                        // 편집해서 새로운 결과값을 만들어내는 역할을 합니다.
