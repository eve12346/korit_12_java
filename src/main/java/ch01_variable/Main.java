...
public class Main {
    public static void main(String[] args) {
        ...
        /*
            ...
            이라고 합니다.
            하드 코딩 : 명령문에 데이터(변수에 대입되지 않는 데이터인데 이를 리터럴(literal))를
        ...
        */
        ...
        String introduction = "안녕하세요, 저는 이번 국비 과정을 맡게 된 곽민성입니다.";
        ...
        /*
            ...
            그리고, sout()의 () 내부에서 가장 먼자 나온 데이터의 자료형을 따라간다는 점도
            확인할 수 있습니다.
        ...
        System.out.println(width2 + width1);    // 결과값 : 300
        System.out.println(width4 + width3);    // 결과값 : 200100
        // 정확하게 말하면 문자열의 + 연산은 수학적 연산이 아니라 "나열"됩니다.
