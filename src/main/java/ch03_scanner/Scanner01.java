...
//        System.out.println(name);
        /*
            ...
            Scanner scanner = new Scanner(System.in);dl '객체 생성'을 했고
            ...
            2. next (Int / double / Boolean, ... etc) vs. nextLine
                - next()은 띄어쓰기ㅡㄹㄹ 허용합니다. enter키를 기준으로 데이터가 변수에 저장됩니다
...
//        System.out.println("이름 : " + name2);
        ...
        /*
            이상의 코드에서의 문제점은 52 번 라인이 실행됬을 때 데이터를 입력 받지 않고
        ...
        scanner.nextLine();     // 얘는 enter만 받아주는거지 그 데이터를 어디다 쓸게 아니니까
                                // 변수에 저장할 필요가 없다. 변수에 저장한다는 건 메모리에 할당한다는 의미이다.
        System.out.println("당신의 이름은 무엇인가요? >>>");
        String name2 = scanner.nextLine();
        System.out.println("연도 : " + year);
        System.out.println("이름 : " + name2);
