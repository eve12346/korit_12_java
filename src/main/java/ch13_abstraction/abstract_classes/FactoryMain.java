...
public class FactoryMain {
    public static void main(String[] args) {
        ...
        /*
            ...
            (Lanbda Expression)으로 대체되는 경우가 많습니다(그리고 JavaScreipt에서도 동일한 방식을
            사용합니다)
        ...
        // 그리고 추상 클래스가 지식 클래스에서 구현부를 작성했으므로
        // 재정의된 대로 출력되는지 확인
        ...
        /*
            어제는 상속 배운 부분과 합쳐져 생각을 해보 ㄹ때, 추상 클래스는
            ...
            직접저긍로 정의되지 않은 메서드를 호출하고 원하는 결과값을 얻을 수 있겠네요.
