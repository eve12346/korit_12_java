...
public class StrList {
    public static void main(String[] args) {
        ...
        // 근데 List의 경ㅇ 삭제하니까 아예 방이 4개짜리로 줄어들었음을 확인할 수 있습니다.
        ...
        /*
            ...
            strArray에 김0 김1 임2 김3 김4 로 집어넣으시오.
        ...
        String[] arr01 = {"김0","김1","김2","김3","김4"};

        for (int i = 0 ; i < arr01.length ; i ++) {
            System.out.print(arr01[i] + " 님 /");
        }
        System.out.println();

        for (String elem : arr01 ) {
            System.out.print(elem + " 학생 - ");
        }
        System.out.println();

        // list는 index 추출할 때 리스트명.size() 씁니다. .length 아니고, method인 점 주의

        // 그러면 일반 for문으로 strList를 java언어 / python 언어 ... 등으로 출력하시오.
