...
public class Array01 {
    public static void main(String[] args) {
        ...
        // 직접 한계값을 하다ㅡ코딩해서 집어넣기가 번거로워집니다.

        // 우리는 컴퓨터한테 직접 한계값을 구해서 알아서 출력하도록 명령을 내릴 필요가
        // 있을 것 같습니다.
        System.out.println();
        // 배열명.length; 근데 우리는 비슷한 걸 봤습니다. 문자열데이터.lenght();
        ...
        /*
            ...
            얘가 다른 언어에 비해서 골치 아픈게, 미리 방의 개수를 지정을 해줘야 합니다.
         ...
         */
        System.out.println();
        int[] arr03 = new int[10];  // 10개 짜리 방을 가진 비어있는 배열을 생성합니다.
        ...
        // 정답: 별 의미없음 / 다만 중요한 것은 처음 값을 대입하는데도 int arr03[0] = 10;이
        // 아니라는 점입니다.
        ...
        // 이상의 빈 배열에 40부터 80까지의 값을 순서대로 대입하고,
