...
public class JSON2 {
    public static void main(String[] args) {
        ...
        /*
            ...
            그리고 JSON1.java 파일을 참조하여 json 데이터로 바꿔보시오.
         */
        ...
        // 그러면 JsonData1 / 2를 userMap1 으로 바꿀 수 있습니다
        // field : fieldValue 로 일대일 매칭이 되니까요.
        /*
            하지만 jsonProduct1 / 2는 Java Object로 못 바꿉니다. → 클래스가 아직 정의되지 않았으니까요.

            그러면 jsonData1을 Map 자료형의 userMap1으로 변경하시오.
            그리고 콘솔에 출력하세요.
         */

        Map<String , String> productData1 = gson.fromJson(jsonData1, Map.class);
