...
public class Main {
    public static void main(String[] args) {
        // rorcp todtjd : default class니까 객체 생성이 가능하겠네요.
...
//        System.out.println(example.protecteVar);  // private 접근 제어자이기 때문에 오류 발생합니다. rield의 직접 조회 불가능
        System.out.println(example.getPublicVar());
    }
}
