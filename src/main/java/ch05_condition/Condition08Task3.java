...
/*
    과제:
        ...
        3. 그런데 100으로 낭누어 떨어지는 해 중에 400으로도 나누어 떨어지면 윤년임.

        예를 들어,
        2020년은 4로 나누어 떨어지기 때문에 유년년(100으로는 안나누어지니까요)
        1900년은 100으로 나누어 떨어지기 때문에 윤년이 아님(400으로 안나누어집니다)
        2000년은 100으로 나누어떨어지기는 하는데 400으로도 나누어 떨어져서 윤년

        이상의 조건을 만족하는 윤년 계산기를 조건문을 만들고 활용해 작성하시고,
        Scanner를 import 하여,
        year 변수에 값을 대입했을 때 윤년인지 아닌지 판별할 수 있도록 하시고.
...
public class Condition08Task3 {
    public static void main(String[] args) {
        ...
        // 이상의 경우 100을 입력했을 때 41번 라인이 true가 되기 때문에
        // 윤년입니다가 출력됩니다
