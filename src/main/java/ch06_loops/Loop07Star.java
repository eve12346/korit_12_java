...
//        }
        /*
         별찍기를 통한 for문 구조 학습
                        i = 0, j = 0 일 경우 반복실행문2가 아예 실행되지 않습니다. 한계값이 0 < 0이 false라서
         *              i = 0, j = 0 일 때 벼링 하나 찍히고, i = 1 / j = 1일 때 false라서 개행
        ...
        /*
            ...
            *
         */
        //역순 별찍기 1 - 개행 담당을 굳이 -- 할 필요가 없어서 0부터 시작하는 방법
        for ( int i = 0 ; i < 6 ; i ++) {
            for ( int j = 6 ; j > i ; j--){
                System.out.print("*");
            }
